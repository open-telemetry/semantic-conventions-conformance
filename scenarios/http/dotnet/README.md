...
of the concrete request in the
[server contract](../../../tools/http/contracts/server.yaml), identical for
every framework, so a route here says only what its template is.
