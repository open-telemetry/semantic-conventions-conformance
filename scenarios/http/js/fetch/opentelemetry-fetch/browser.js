...
const { drive } = require("@otel-conformance/fetch-scenarios");

/** Resolves once exactly `expected` Fetch spans have reached the exporter. */
...
async function run() {
  ...
  registerInstrumentations({
    ...
    instrumentations: [
      new FetchInstrumentation({ ignoreUrls: [traceExporterUrl] }),
    ],
  });
