 ...
 */
package io.opentelemetry.conformance.http.springwebmvc.v5_3;
...
/** Hosts the shared HTTP exchanges on Spring Web MVC 5 until the driver says stop. */
public final class SpringWebMvc5ServerScenario {
  private SpringWebMvc5ServerScenario() {}
