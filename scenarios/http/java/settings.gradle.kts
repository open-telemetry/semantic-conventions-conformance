...
include("jax-rs:scenarios")
include("jax-rs:opentelemetry-javaagent")
...
include("spring-webmvc:opentelemetry-javaagent")
...
include("vertx-web:scenarios")
include("vertx-web:opentelemetry-javaagent")
