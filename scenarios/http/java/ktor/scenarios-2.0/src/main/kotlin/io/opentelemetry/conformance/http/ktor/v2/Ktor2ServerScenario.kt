 ...
 */
package io.opentelemetry.conformance.http.ktor.v2
...
/** Hosts the shared HTTP exchanges on Ktor 2 until the driver says stop. */
object Ktor2ServerScenario {
    ...
    private suspend fun PipelineContext<Unit, ApplicationCall>.answer(body: String? = null) {
        val response =
