...
Initial support is Java-only and exercises PostgreSQL, MariaDB, and Oracle
Database through JDBC. Each vendor runs against the OpenTelemetry Java agent
...
java/{postgresql,mariadb,oracle}/jdbc/      vendor conformance packages
```
...
otel-conformance scenarios/database/java/oracle/jdbc/opentelemetry-javaagent
otel-conformance scenarios/database/java/oracle/jdbc/opentelemetry-library
```
...
[Oracle](../../tools/database/runner/src/database_conformance/oracle.sql)
schemas. They contain the empty table and stored procedure used by the shared
