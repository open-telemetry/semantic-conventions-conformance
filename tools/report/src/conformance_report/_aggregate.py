...
# Sorts to the top of the document, so the first line of the file a reader
# opens says where it came from. JSON has no comments; this is the header.
DO_NOT_EDIT = (
    "Generated by `otel-conformance-report build`. Do not modify by "
    "hand: rebuild instead. See tools/report/README.md."
)
