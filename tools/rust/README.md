...
collector endpoint, applies the runner's metric export interval, creates tonic
gRPC trace and metric exporters, installs the providers globally for
instrumentation libraries, and shuts both down after the workload ends.
